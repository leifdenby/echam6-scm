      PROGRAM surface_rd_anymon 

      open(unit=1,file='surface_yymm.dat',status='old')
      read(1,*)
      read(1,*)  NVAR
      read(1,*)
      read(1,*)  NT
      ...
      print *, NVAR, NT
      call read_surface_data(NVAR, NT)
      ...
      subroutine read_surface_data(NVAR, NT)
...
c     +     'omega_surface_(mb/hr)','qs_surface_(kg/kg)', 
c     +     's_surface_(K)','MWR_precip_water_(cm)', 
c     +     'Siros_Srf_LWUP_(W/m2)','Siros_Srf_LWDN_(W/m2)',
c     +     'Siros_Srf_SWUP_(W/m2)','Siros_Srf_SWDN _(W/m2)' ]  
